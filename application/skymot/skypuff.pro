...
# Skymot 1.5.0 (from ddosoff/vesc_tool skypuff 6.05), minSdk 26 (Android 8), arm64-v8a only
VT_ANDROID_VERSION_ARMV7 = 150
VT_ANDROID_VERSION_ARM64 = 150
VT_ANDROID_VERSION_X86 = 150
...
# Positioning (disabled: no qtpositioning for android in 5.15.2, code not using it)
#DEFINES += HAS_POS
