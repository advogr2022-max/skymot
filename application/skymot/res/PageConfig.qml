                        ...
                        RowLayout {
                            Text {
                                ...
                                onLinkActivated: VescIf.emitMessageDialog(qsTr("Takeoff trigger distance"),
                                                                          qsTr("After pre pull timeout is passed skymot will detect motion. In case of motion more then this distance takeoff pull will be applied."),
                                                                          false, false);
                            }
                            Item {Layout.fillWidth: true}
                            RealSpinBox {
